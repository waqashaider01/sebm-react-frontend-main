        ...
        <div className="row gap-5 flex-column-reverse flex-md-row">
          <div className="col-md align-self-center">
            <p data-aos="fade-right">
              If you Sign Up under Code{" "}
              <span className="text-primary">"SEBM"</span> you automatically
              enter the{" "}
              <span className="text-primary">$10,000 Monthly Leaderboard.</span>{" "}
              You Compete by playing Slots, LiveGame, House Games... on
              500.casino. When it all comes down an End, the Prices of the
              Leaderboard get paid out to the first 10 Players. Prices between{" "}
              <span className="text-primary">$50-$5,000 per Person</span> get
              paid out Monthly!
            </p>
